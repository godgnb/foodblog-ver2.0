...
<%@page import="com.blog.vo.TipBoardVO"%>
<%@page import="com.blog.dao.TipBoardDao"%>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    ...
                    <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
                        <!-- Blog Thumbnail -->
                        <form action="delete.do" method="post" id="frm" name="frm" class="frm" onsubmit="return passwdCheck();">
